...
public class Scanner extends Lexer {
	...
	public static final int
		...
		CHAR=31, RELATIONAL_OPERATOR=32, ARITHMETIC_OPERATOR=33, IDENTIFICADOR=34, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"IDENTIFICADOR", "NEW_LINE", "WHITE_SKEEP", "COMMENTS"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, null, null, null, null, null, "'void'", null, "'extends'", "'class'", 
			"'import'", "'package'", "'super'", "'this'", "'new'", "'return'", "'null'", 
			"'if'", "'else'", "'while'", "'instanceof'", "'('", "')'", "'{'", "'}'", 
			"'['", "']'", "';'", "','", "'.'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"CLOSE_PARENTHESIS", "OPEN_BRACES", "CLOSE_BRACES", "OPEN_BRACKETS", 
			"CLOSE_BRACKETS", "END_STATEMENT", "SEMICOLON", "DOT", "STRING", "CHAR", 
			"RELATIONAL_OPERATOR", "ARITHMETIC_OPERATOR", "IDENTIFICADOR", "NEW_LINE", 
			"WHITE_SKEEP", "COMMENTS"
		};
	}
